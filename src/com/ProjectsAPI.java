...
public class ProjectsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = projectObj.insertProject(request.getParameter("projectTitle"), 
				 request.getParameter("projectDescription"), 
				 request.getParameter("projectProposalLink"), 
				 request.getParameter("projectVideoLink")); 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = projectObj.updateProject(paras.get("hidProjectIDSave").toString(), 
					...
					paras.get("projectProposalLink").toString(), 
					paras.get("projectVideoLink").toString()); 
